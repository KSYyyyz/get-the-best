...
- `docs/get_the_best_algorithm_a0_27_3_rest_lifecycle_acceptance_report.md`
- `docs/get_the_best_algorithm_a0_27_4_frontend_explanation_events_acceptance_report.md`
...
- 算法工作默认在 `codex/algorithm-core` 分支推进，再通过 PR 或人工确认合入主线。
