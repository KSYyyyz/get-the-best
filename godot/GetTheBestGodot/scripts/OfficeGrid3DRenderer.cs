...
{
    private static readonly Color GridColor = new(0.56f, 0.66f, 0.60f, 0.72f);
    ...
    private void BuildGrid()
    {
        ...
        for (var x = 0; x <= OfficeWorld3DConfig.Columns; x++)
        {
            ...
            AddLine(
                ...
                new Vector3(0.035f, 0.035f, OfficeWorld3DConfig.OfficeBounds.Size.Y),
                material
            );
        }
        ...
        for (var y = 0; y <= OfficeWorld3DConfig.Rows; y++)
        {
            ...
            AddLine(
                ...
                new Vector3(OfficeWorld3DConfig.OfficeBounds.Size.X, 0.035f, 0.035f),
                material
            );
        }
    }
